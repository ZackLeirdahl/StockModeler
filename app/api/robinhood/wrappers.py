...
def post_login(func):
    def wrapper(self, *args, **kwargs):
        ...
        if not self.authenticated:
            with open(r'C:\Users\zleirdahl\Documents\GitHub\StockModeler\robinhood_auth.json', 'w') as f:
...
def pre_login(func):
    @wraps(func)
    def wrapper(self):
        with open(r'C:\Users\zleirdahl\Documents\GitHub\StockModeler\robinhood_cred.json', 'r') as f:
        ...
        if os.path.exists(r'C:\Users\zleirdahl\Documents\GitHub\StockModeler\robinhood_auth.json'):
            if (int(time.time()) - int(os.path.getmtime(r'C:\Users\zleirdahl\Documents\GitHub\StockModeler\robinhood_auth.json')))/3600 > 22:
                os.remove(r'C:\Users\zleirdahl\Documents\GitHub\StockModeler\robinhood_auth.json')
